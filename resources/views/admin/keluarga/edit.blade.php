                ...
                <div class="card-body">
                    <form action="{{ route('keluargas.update', $keluarga->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" required value="{{ old('nama', $keluarga->nama) }}">
                            @error('nama')
